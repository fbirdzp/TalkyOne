    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">管理你的课程预约</p>
        </div>
        ...
        {bookings.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <Link href="/teachers" className="mt-4 inline-block">
                <Button>去约课</Button>
              </Link>
            </CardContent>
          </Card>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="mb-3 flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-semibold">{booking.teacher.user.name}</h3>
                            <p className="text-sm text-gray-600">{booking.teacher.title}</p>
                          </div>
                        </div>
                      ...
                      <div className="ml-4 flex flex-col gap-2">
                        ...
                        <Link href={`/teachers/${booking.teacher.id}`}>
